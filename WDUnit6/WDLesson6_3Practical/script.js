...
function showSeafood(){
  ...
  */
  for(let s = 0; s < seafood.length; s++){
  build += `<div class = "card">
    <h3>${seafood[s].title}</h3>
    <img src = "images/${seafood[s].image}">
    <p>$${seafood[s].price}</p>
  </div>`;
 }
...
function showDesserts(){
  ...
  */
  ...
  build += `<div class = "card">
    <h3>${desserts[d].title}</h3>
    <img src = "images/${desserts[d].image}">
    <p>$${desserts[d].price}</p>
  </div>`;
